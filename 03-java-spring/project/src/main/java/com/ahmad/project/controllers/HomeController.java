package com.ahmad.project.controllers;
...
import com.ahmad.project.services.UserService;
import com.ahmad.project.models.Art;
import com.ahmad.project.models.Rating;
import com.ahmad.project.models.User;
import com.ahmad.project.services.ArtService;
import com.ahmad.project.validator.UserValidator;
...
//Get art details 
		...
		@GetMapping("/arts/{id}/edit")
		public String edit(@PathVariable("id") Long id, @ModelAttribute("editedProject") Art art, Model model,
				HttpSession session) {
			Art editProject = artService.getOneArt(id);
