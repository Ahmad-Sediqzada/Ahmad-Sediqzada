package com.ahmad.ABC.controllers;
...
import com.ahmad.ABC.services.ProjectService;
import com.ahmad.ABC.services.UserService;
import com.ahmad.ABC.validators.UserValidator;
...
//	 **********************Project Routes************************* 
	...
	// Project Dashboard
		@GetMapping("/projects")
		public String projects(Model model, HttpSession session, @ModelAttribute("newProject") Project project) {
	...
	// Get One user Projects
		@GetMapping("/projects/user_project/{id}")
		public String alluserprojects(@PathVariable("id") Long projectId, Model model, HttpSession session) {
